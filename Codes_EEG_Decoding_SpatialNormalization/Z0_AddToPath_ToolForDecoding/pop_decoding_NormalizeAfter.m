...
if method == 1 %SVM
    [MVPC, ALLMVPC] = erp_decoding_NormalizeAfter(ALLBEST,nIter,nCrossblocks,decodeTimes,chanArray,classcoding,equalize_trials,ParWorkers,method,BetaWeights,Tooltype);
